    ...
    <div class="modal-content">
      ...
      <form id="formAñadir">
        <div class="modal-body">   
            <div class="row mb-3">
                <div class="col-md-12 text-center">
                    <strong>Ubicacion
                        <select class="form-control text-center btn btn-outline-secondary" id="seleccionAulaAñadir">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="codigoAñadir" class="form-control" required>
                    </strong>
                </div>
                <div class="col-md-6">
                    <strong>Nombre
                    <input type="text" id="nombreAñadir" class="form-control" required>
                    </strong>
                </div> 
            </div>
        </div>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success" onclick="guardarEquipo()"><i class="bi bi-floppy"></i> Guardar</button>
